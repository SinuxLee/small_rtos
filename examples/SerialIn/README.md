...
注意:
1. 在KEIL C51 工程中,我已经把输出文件目录设在e:\temp中，您可以在Project->Options for Target "Target 1"的output页，点击Select Folder for Objects...和Listing页点，击Select Folder for Listing...改变.
